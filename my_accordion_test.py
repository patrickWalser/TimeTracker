...
class TestAccordionElement(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.section = self.accordion.add_section(
            "Section 1", lambda: print("Section 1 clicked"))
    ...
    def test_add_element(self):
        # add one element
        element = self.section.add_element(
            "Item 1.1", lambda: print("Item 1.1 clicked"))
        ...
        element21 = Accordion_Element(
            self.accordion, frame, "Item 1.2.1", lambda: print("Item 1.2.1 clicked"))
        element2 = self.section.add_element(
            "Item 1.2", lambda: print("Item 1.2 clicked"), [element21])
        ...
        element31 = Accordion_Element(
            self.accordion, frame, "Item 1.3.1", lambda: print("Item 1.3.1 clicked"))
        element32 = Accordion_Element(
            self.accordion, frame, "Item 1.3.2", lambda: print("Item 1.3.2 clicked"))
        element3 = Accordion_Element(self.accordion, frame, "Item 1.3", lambda: print(
            "Item 1.3 clicked"), [element31, element32])
    ...
    def test_reorder(self):
        element1 = self.section.add_element(
            "Item 1.1", lambda: print("Item 1.1 clicked"))
        element2 = self.section.add_element(
            "Item 1.2", lambda: print("Item 1.2 clicked"))
    ...
    def test_destroy(self):
        ...
        section = accordion.add_section(
            "Section 1", lambda: print("Section 1 clicked"))
        element1 = section.add_element(
            "Item 1.1", lambda: print("Item 1.1 clicked"))
        element2 = section.add_element(
            "Item 1.2", lambda: print("Item 1.2 clicked"))
        sub_element = element2.add_element(
            "Item 1.2.1", lambda: print("Item 1.2.1 clicked"))
...
class TestAccordion(unittest.TestCase):
    ...
    def test_add_section(self):
        # add a section
        section1 = self.accordion.add_section(
            "Section 1", lambda: print("Section 1 clicked"))
        ...
        element1 = Accordion_Element(
            self.accordion, frame, "Item 2.1", lambda: print("Item 2.1 clicked"))
        section2 = self.accordion.add_section(
            "Section 2", lambda: print("Section 2 clicked"), [element1])
        ...
        element2 = Accordion_Element(
            self.accordion, frame, "Item 2.2", lambda: print("Item 2.2 clicked"))
        section3 = self.accordion.add_section(
            "Section 3", lambda: print("Section 3 clicked"), [element1, element2])
    ...
    def test_update_canvas_width(self):
        section = self.accordion.add_section(
            "Section 1", lambda: print("Section 1 clicked"))
        element = section.add_element(
            "Item 1.1 long text", lambda: print("Item 1.1 clicked"))
        # collapsed
        ...
        element.toggle_element()
        self.accordion.update_canvas_width()
        self.assertGreater(self.accordion.scrollable_frame.winfo_width(
        ), section.collapse_btn.winfo_reqwidth())
        self.assertGreater(
            self.accordion.scrollable_frame.winfo_reqwidth(), collapsed_width)

    def test_reorder(self):
        section1 = self.accordion.add_section(
            "Section 1", lambda: print("Section 1 clicked"))
        section2 = self.accordion.add_section(
            "Section 2", lambda: print("Section 2 clicked"))
        element1 = section1.add_element(
            "Item 1.1", lambda: print("Item 1.1 clicked"))
        element2 = section1.add_element(
            "Item 1.2", lambda: print("Item 1.2 clicked"))
        element3 = section2.add_element(
            "Item 2.1", lambda: print("Item 2.1 clicked"))
    ...
    def test_create_style(self):
        ...
        self.assertEqual(style.map(style_name, 'background'),
                         [('active', '#d0d0d0')])
        self.assertEqual(style.map(style_name, 'foreground'),
                         [('active', '#000000')])

    def test_destroy(self):
        accordion = Accordion(self.root)
        section1 = accordion.add_section(
            "Section 1", lambda: print("Section 1 clicked"))
        section2 = accordion.add_section(
            "Section 2", lambda: print("Section 2 clicked"))
        element1 = section1.add_element(
            "Item 1.1", lambda: print("Item 1.1 clicked"))
        element2 = section1.add_element(
